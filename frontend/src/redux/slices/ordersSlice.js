...
const ordersSlice = createSlice({
  ...
  reducers: {
    ...
    closeDeleteModal: (state) => {
      ...
      state.deleteModal.orderId = null;
      state.deleteModal.orderName = null;
    },
    clearError: (state) => {
      state.error = null;
    },
    ...
    builder
      ...
      .addCase(fetchOrders.fulfilled, (state, action) => {
        ...
        state.orders = orders.map(order =>
          calculateOrderTotals(order, products)
        );
      })
      ...
      .addCase(fetchOrderById.fulfilled, (state, action) => {
        ...
        state.currentOrder = calculateOrderTotals(order, products);
      })
